...
const makeXmlObject = (zodiac, data) => {
  ...
  const base = {
    horoscope: [
      {
        [zodiac]: [
          { title: `Гороскоп ${name.a} на ${date} - Астрологический прогноз для женщин и мужчин` },
          { description: `Бесплатный гороскоп ${name.a} на ${date} для мужчин и женщин. Ежедневный онлайн гороскоп для Овна о здоровье, любви, бизнесе, дружбе и сексе для женщин и мужчин` },
          { header: `Гороскоп ${name.a} на ${date}` },
          { categories: name.a },
          { text },
          { url },
        ],
